...
INSERT INTO DEVICE_ITEM VALUES (NULL,@service_device_windows, @device);
INSERT INTO DEVICE_ITEM VALUES (NULL,@service_antivirus_windows, @device);
INSERT INTO DEVICE_ITEM VALUES (NULL,@service_backup_windows, @device);
INSERT INTO DEVICE_ITEM VALUES (NULL,@service_screen_windows, @device);
...
SET @device = identity();
-- Insert the services chosen for the device (service psa is not included)
INSERT INTO DEVICE_ITEM VALUES (NULL,@service_device_windowss, @device);
INSERT INTO DEVICE_ITEM VALUES (NULL,@service_antivirus_windowss, @device);
INSERT INTO DEVICE_ITEM VALUES (NULL,@service_backup_windowss, @device);
INSERT INTO DEVICE_ITEM VALUES (NULL,@service_screen_windowss, @device);

-- For testing, create some mac devices
INSERT INTO DEVICE VALUES (null,'FIRST MAC SYSTEM',@MAC);
SET @device = identity();
-- Insert the services chosen for the device (service psa is not included)
INSERT INTO DEVICE_ITEM VALUES (NULL,@service_device_mac, @device);
INSERT INTO DEVICE_ITEM VALUES (NULL,@service_antivirus_mac, @device);
INSERT INTO DEVICE_ITEM VALUES (NULL,@service_backup_mac, @device);
INSERT INTO DEVICE_ITEM VALUES (NULL,@service_screen_mac, @device);
